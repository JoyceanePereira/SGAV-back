...
from .models import Perfil, Tarefas
...
def cardpessoal (request):
    ...
    if request.method == 'POST':
        tarefas = request.POST['tarefa']
        print('tarefas', request.user.id)
        Tarefas(tarefa=tarefas, user=perfil).save()
    return render (request, 'card-pessoal.html', {'perfil':perfil, 'tarefas':tarefas})
